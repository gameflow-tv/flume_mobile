...
class FlumeThemeAdapter {
  ...
  ThemeData get theme {
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        displayLarge: typography.header1.toTextStyle(),
        displayMedium: typography.header2.toTextStyle(),
        displaySmall: typography.header3.toTextStyle(),
        headlineMedium: typography.header4.toTextStyle(),
        headlineSmall: typography.header5.toTextStyle(),
        titleLarge: typography.header5.toTextStyle(),
        titleMedium: typography.label1.toTextStyle(),
        titleSmall: typography.label2.toTextStyle(),
        bodyLarge: typography.body1.toTextStyle(),
        bodyMedium: typography.body2.toTextStyle(),
        labelLarge: typography.button.toTextStyle(),
        bodySmall: typography.body3.toTextStyle(),
        labelSmall: typography.label3.toTextStyle(),
      ),
    );
  }
